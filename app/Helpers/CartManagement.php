...
class CartManagement
{
    ...
    static public function incrementQuantityCartItems($product_id)
    {
        $cart_items = self::getCartItemsFromCookie($product_id);
    ...
    static public function decrementQuantityCartItems($product_id)
    {
        $cart_items = self::getCartItemsFromCookie();
        foreach ($cart_items as $key => $item) {
            if ($item['product_id'] == $product_id) {
