<div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto" x-data="paginationHandler()">
    ...
    function paginationHandler() {
        return {
            ...
            updateItemsPerPage() {
                ...
                @this.set('itemsPerPage', itemsCount); // Call Livewire method
            }
        }
    }
</script>
